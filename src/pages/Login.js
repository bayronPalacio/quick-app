            ...
            <div className="dropdown-menu-right">
              <form className="px-4 py-3">
                ...
                <button
                  ...
                  className="btn button-color btn-block"
                >
                  Sign in
                </button>
                <p className="text-center font-italic font-weight-light">
                  By clicking Sign In, you agree to our Terms.
                </p>
                <div className="dropdown-divider"></div>
                <a
                  className="dropdown-item text-center font-italic"
                  href="./Registration"
                >
                  No Acount? Sign up
                </a>
                <a className="dropdown-item text-center font-italic" href="#">
                  Forgot password?
                </a>
              </form>
            </div>
